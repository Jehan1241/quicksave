function DisplayInfo(props) {
  ...
  return (
    <div className="flex overflow-scroll flex-col p-2 h-2/3 text-left rounded-b-2xl border-2 border-gray-500">
      ...
      <div className="flex flex-row">
        <p className="p-2 mx-2 w-1/2 border-r-2 border-gray-500">Time Played</p>
