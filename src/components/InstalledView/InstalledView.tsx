...
import DetialsMaker from "@/components/LibraryView/DetailsMaker";
import GridMaker from "@/components/LibraryView/GridMaker";
...
export default function InstalledView({ data }: InstalledViewProps) {
  ...
  return (
    <div className="absolute flex h-full w-full flex-col justify-center select-none">
      <ViewHeader view={view} setView={setView} text={"Installed Games"} />
      {view === "grid" && (
        <GridView
          data={data}
